        ...
        <div className=" flex justify-center items-center py-5">
            <div className="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
                ...
                <form onSubmit={handleRegister} className="mt-6 mb-2 w-80 max-w-screen-lg sm:w-96">
                    ...
                    <button
                        className="btn mt-3 block w-full select-none rounded-lg bg-[#F9A51A] py-3 px-6 text-center align-middle  text-base font-bold  text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
